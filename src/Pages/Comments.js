                  ...
                  <tr>
                    ...
                    {blog.action === "approved" ? (
                      <td>Approved
                          ...
                          style={{ color: "#944b43" }}
                          onClick={()=>handleDeleteBlog(blog.id)} ></i>
                      </td>
                    ) : (
                      <td>
                        <button
                        ...
                        <button type="button" className="btn btn-danger"   onClick={()=>handleDeleteBlog(blog.id)}
                        >
                          رفض
                        </button>
                      </td>
                  ...
                  <tr>
                    ...
                    {course.action === "approved" ? (
                      <td>Approved
                          ...
                          className="fa-regular fa-trash-can fa-lg"
                          style={{ color: "#944b43" }}
                          onClick={()=>handleDeleteCourse(course.id)} ></i>
                      </td>
                    ) : (
                      <td>
                        <button
                        ...
                        <button type="button" className="btn btn-danger" onClick={()=>handleDeleteCourse(course.id)}  
                        >
                          رفض
                        </button>
                      </td>
                    ...
                    {comment.action === "approved" ? (
                      <td>Approved
                         <i
                          className="fa-regular fa-trash-can fa-lg"
                          style={{ color: "#944b43" }}
                          onClick={()=>handleDeleteComments(comment.id)} ></i>
                      </td>
                      ...
                      <td>
                        ...
                        <button type="button" className="btn btn-danger" onClick={()=>handleDeleteComments(comment.id)} 
                        >
                          رفض
                        </button>
                      </td>
